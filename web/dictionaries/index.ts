...
export const en: Dictionary = {
    ...
    home: {
        ...
        coreValues: {
            ...
            hongik: { title: 'Hongik (Benefit)', desc: 'The creative spirit (DNA) of Koreans that benefits the world' },
            wisdom: { title: 'Wisdom', desc: 'Reasoning (thought), reflection (introspection), awakening (realization)' },
...
export const ko: Dictionary = {
    ...
    home: {
        ...
        coreValues: {
            ...
            hongik: { title: '홍익', desc: '세상을 이롭게 하는 한국인의 창조 정신(DNA)' },
            wisdom: { title: '지혜', desc: '사유(생각), 성찰(반성), 각성(깨달음)' },

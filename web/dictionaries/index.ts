...
export const en: Dictionary = {
    navbar: {
        ...
        education: 'Korean Studies',
        kLanguage: 'K-Heritage Language',
        kLiterature: 'Korean Humanities',
        kStudies: 'K-Studies',
        tours: 'K-Heritage',
    ...
    footer: {
        ...
        contactInfo: 'Contact',
        phone: '+82 010-2886-7392',
        email: 'youna789@gmail.com',
        sns: '@세계왕립아카데미',
    ...
    pages: {
        ...
        education: {
            ...
            literatureTitle: 'Korean Humanities',

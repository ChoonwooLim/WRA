...
export const en: Dictionary = {
    ...
    home: {
        ...
        titleLine2: 'Academy',
        subtitle: 'The World Royal Academy combines prestigious tradition with cutting-edge technology. A global platform bridging education, culture, and business through the Korean Royal heritage.',
        ...
        coreValues: {
            ...
            subtitle: 'The three pillars that define World Royal Academy',
            heritage: { title: 'Heritage', desc: 'Preserving and honoring the traditions of the Korean Imperial family through digital innovation.' },
            harmony: { title: 'Harmony', desc: 'Uniting global education, culture, and business in a harmonious fusion of East and West.' },
            humanity: { title: 'Humanity', desc: 'Upholding Noblesse Oblige — a commitment to social responsibility and philanthropic leadership.' },
        },
        warrantHighlights: {
            title: 'WRA Warrants',
    ...
    footer: {
        description: 'A global platform bridging education, culture, and business through the Korean Royal heritage.',
    ...
    pages: {
        crownPrince: {
            ...
            introduction: 'Direct descendant of Emperor Gojong, HRH Crown Prince Lee Won continues the legacy of the Korean Imperial Family through cultural heritage restoration and global diplomatic exchanges.',
        ...
        education: {
            ...
            step2: 'Questioning',
            step3: 'Discussion',
            step4: 'Writing & Publication',
            studiesTitle: 'K-Studies',
            studiesDesc: 'Explore the Korean spirit, UNESCO heritage, and the bridge between tradition and modern K-wave.',
        },
        certification: {
...
export const ko: Dictionary = {
    ...
    home: {
        ...
        titleLine1: '세계 왕립',
        titleLine2: '아카데미',
        subtitle: '세계 왕립 아카데미는 대한제국 황실의 정통 문화유산을 기반으로 교육, 문화, 비즈니스를 융합하는 글로벌 플랫폼입니다.',
        ...
        coreValues: {
            title: '핵심 가치',
            subtitle: '세계왕립아카데미를 정의하는 세 가지 기둥',
            heritage: { title: 'Heritage 전통', desc: '디지털 혁신을 통해 대한제국 황실의 전통을 보존하고 계승합니다.' },
            harmony: { title: 'Harmony 조화', desc: '글로벌 교육, 문화, 비즈니스를 동서양의 조화로운 융합으로 하나로 묶습니다.' },
            humanity: { title: 'Humanity 인류애', desc: '노블레스 오블리주 — 사회적 책임과 박애적 리더십에 대한 헌신을 실천합니다.' },
        },
        warrantHighlights: {
            title: 'WRA 워런트',
    ...
    footer: {
        description: '대한제국 황실의 정통 문화유산을 기반으로 교육, 문화, 비즈니스를 융합하는 글로벌 플랫폼.',
        quickLinks: '바로가기',
        contactInfo: '연락처',
        phone: '+82 10-2886-7392',
        email: 'info@wra.academy',
        sns: '@세계왕립아카데미',
        copyright: '© 2026 세계 왕립 아카데미. All Rights Reserved.',
    },
    pages: {
        crownPrince: {
            heroTitle: '황태손 이원 전하',
            ...
            fullName: '이원 (Lee Won)',
            title: '대한제국 5대 황태손',
            introduction: '고종 황제의 직계 후손으로, 황태손 이원 전하는 문화유산 환수와 글로벌 문화외교를 통해 대한제국 황실의 유산을 이어가고 계십니다.',
            lineageTitle: '황실 계보',
        ...
        education: {
            ...
            step3: '토론 (Discussion)',
            step4: '창작·출판 (Writing & Publication)',
            studiesTitle: '한국학 (K-Studies)',
            studiesDesc: '한국정신, UNESCO 문화유산, 전통과 현대 K-Wave의 연결고리를 탐구합니다.',
        },
        certification: {

    ...
    return (
        <div className="w-full flex flex-col gap-32 py-16">
            ...
            <section className="container mx-auto px-4 max-w-5xl">
                ...
                >
                    <button onClick={(e) => toggleSection('s1', e.currentTarget)} className="flex items-center justify-center gap-3 mx-auto cursor-pointer">
                        <h2 className="text-3xl md:text-4xl font-bold text-white">왜 지금 한국어 교육인가?</h2>
                        <span className={`text-[#d4af37] text-xl transition-transform duration-300 ${sectionOpen === 's1' ? 'rotate-180' : ''}`}>▾</span>
                    </button>
            ...
            <section className="container mx-auto px-4 max-w-5xl">
                <motion.div
                    ...
                    className="text-center mb-16"
                >
                    <button onClick={(e) => toggleSection('s2', e.currentTarget)} className="flex items-center justify-center gap-3 mx-auto cursor-pointer">
                        <h2 className="text-3xl md:text-4xl font-bold text-white">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#d4af37] to-[#fceda6]">TOPIK</span> - 한국어 학습의 핵심 목표
                        </h2>
                        <span className={`text-[#d4af37] text-xl transition-transform duration-300 ${sectionOpen === 's2' ? 'rotate-180' : ''}`}>▾</span>
                    </button>
                    <div className="h-1 w-20 bg-[#d4af37] mx-auto rounded-full mt-4"></div>
                </motion.div>
            ...
            <section className="container mx-auto px-4 max-w-5xl">
                ...
                >
                    <button onClick={(e) => toggleSection('s3', e.currentTarget)} className="flex items-center justify-center gap-3 mx-auto cursor-pointer">
                        <h2 className="text-3xl md:text-4xl font-bold text-white">
                            <span className="text-[#d4af37]">TOPIK</span>이 결정하는 기회
                        </h2>
                        <span className={`text-[#d4af37] text-xl transition-transform duration-300 ${sectionOpen === 's3' ? 'rotate-180' : ''}`}>▾</span>
                    </button>
                    <p className="text-xl text-gray-300 mt-3">대학 · 취업 · 비자의 필수 관문</p>
                    <div className="h-1 w-20 bg-[#d4af37] mx-auto rounded-full mt-4"></div>
                </motion.div>
            ...
            <section className="container mx-auto px-4 max-w-6xl">
                <motion.div
                    ...
                    className="mb-12 text-center"
                >
                    <button onClick={(e) => toggleSection('s4', e.currentTarget)} className="flex items-center justify-center gap-3 mx-auto cursor-pointer">
                        <h2 className="text-3xl md:text-4xl font-bold text-white">
                            온라인 <span className="text-[#d4af37]">TOPIK</span> 모의고사 시장 현황
                        </h2>
                        <span className={`text-[#d4af37] text-xl transition-transform duration-300 ${sectionOpen === 's4' ? 'rotate-180' : ''}`}>▾</span>
                    </button>
                    <div className="h-1 w-20 bg-[#d4af37] mx-auto rounded-full mt-4"></div>
                </motion.div>
            ...
            <section className="container mx-auto px-4 max-w-6xl">
                <motion.div
                    ...
                    className="mb-12 text-center"
                >
                    <button onClick={(e) => toggleSection('s5', e.currentTarget)} className="flex items-center justify-center gap-3 mx-auto cursor-pointer">
                        <h2 className="text-3xl md:text-4xl font-bold text-white">
                            검증된 콘텐츠와 기술의 결합
                        </h2>
                        <span className={`text-[#d4af37] text-xl transition-transform duration-300 ${sectionOpen === 's5' ? 'rotate-180' : ''}`}>▾</span>
                    </button>
                    <div className="h-1 w-20 bg-[#d4af37] mx-auto rounded-full mt-4"></div>
                </motion.div>
            ...
            <section className="container mx-auto px-4 max-w-6xl">
                <motion.div
                    ...
                    className="mb-12 text-center"
                >
                    <button onClick={(e) => toggleSection('s6', e.currentTarget)} className="flex items-center justify-center gap-3 mx-auto cursor-pointer">
                        <h2 className="text-3xl md:text-4xl font-bold text-white">
                            목표 시장 분석
                        </h2>
                        <span className={`text-[#d4af37] text-xl transition-transform duration-300 ${sectionOpen === 's6' ? 'rotate-180' : ''}`}>▾</span>
                    </button>
                    <p className="text-xl text-[#d4af37] mt-3">누가 필요로 하는가?</p>
                    <div className="h-1 w-20 bg-[#d4af37] mx-auto rounded-full mt-4"></div>
                </motion.div>
            ...
            <section className="container mx-auto px-4 max-w-6xl mt-16 mb-16">
                <motion.div
                    ...
                    className="mb-12 text-center"
                >
                    <button onClick={(e) => toggleSection('s7', e.currentTarget)} className="flex items-center justify-center gap-3 mx-auto cursor-pointer">
                        <h2 className="text-3xl md:text-4xl font-bold text-white">
                            국내유학시장 <span className="text-[#d4af37]">기회와 전망</span>
                        </h2>
                        <span className={`text-[#d4af37] text-xl transition-transform duration-300 ${sectionOpen === 's7' ? 'rotate-180' : ''}`}>▾</span>
                    </button>
                    <div className="h-1 w-20 bg-[#d4af37] mx-auto rounded-full mt-4"></div>
                </motion.div>
            ...
            <section className="container mx-auto px-4 max-w-6xl mb-16">
                <motion.div
                    ...
                    className="mb-12 text-center"
                >
                    <button onClick={(e) => toggleSection('s8', e.currentTarget)} className="flex items-center justify-center gap-3 mx-auto cursor-pointer">
                        <h2 className="text-3xl md:text-4xl font-bold text-white">
                            차별점 <span className="text-gray-500 font-light mx-2">&</span> 경쟁력
                        </h2>
                        <span className={`text-[#d4af37] text-xl transition-transform duration-300 ${sectionOpen === 's8' ? 'rotate-180' : ''}`}>▾</span>
                    </button>
                    <div className="h-1 w-20 bg-[#d4af37] mx-auto rounded-full mt-4"></div>
                </motion.div>
                        ...
                        <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3 }} className="overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <motion.div
                                    ...
                                    className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-indigo-500/50 transition-all duration-300 group"
                                >
                                    <div className="flex items-center gap-4 mb-6 pb-4 border-b border-white/5">

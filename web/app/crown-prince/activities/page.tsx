...
const activities = [
    {
        ...
        items: [
            <>종묘대제 초헌관 봉직<br />(UNESCO 세계무형유산)</>,
            '사직대제 초헌관 봉직',
            <>환구대제 초헌관 봉직<br />(대한제국 고유 황제의례)</>,
            <>황실 주요 5대 제향에서<br />국왕 역할 수행</>,
        ],
    },
    {
        ...
        items: [
            <>명성황후 화조도접선 환수<br />(서울역사박물관 기증)</>,
            '황실 노리개 등 국보급 문화재 환수',
            <>일제강점기 해외 유출 황실 문화재<br />환수</>,
            '국립고궁박물관 협력 보존 프로젝트',
        ],
    },
    {

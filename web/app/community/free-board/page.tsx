...
import { Search, Pen, ThumbsUp, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function FreeBoardPage() {
    ...
    const fetchPosts = useCallback(async () => {
        setLoading(true);
        try {
            const params = new URLSearchParams({ board: 'free-board', page: String(page), limit: '10' });
        ...
        <div className="bg-[#050510] min-h-screen pt-[100px] pb-20 px-4">
            <div className="board-container">
                ...
                <div className="board-controls">
                    ...
                    <Link href="/community/write?board=free-board" className="btn-tv-primary">

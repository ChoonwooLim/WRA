            ...
            <section className="relative py-32 overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-4 max-w-4xl text-center">
                    <GlassCard className="p-10 !bg-gradient-to-br !from-[#d4af37]/10 !to-[#d4af37]/5 !border-[#d4af37]/30 backdrop-blur-xl">
                        ...
                        <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 mb-10 mx-auto">
                            <div className="group cursor-default transition-all duration-300 hover:scale-110 hover:-translate-y-1 flex flex-col items-center justify-center bg-transparent py-2">
                                <span className="text-2xl md:text-[2rem] font-black tracking-tighter relative top-[2px] transition-colors duration-300 animate-pulse-gold" style={{ animationDelay: "0s" }}>홍익인간</span>
                                <span className="text-sm md:text-base text-[#d4af37]/70 group-hover:text-[#d4af37] font-serif tracking-tighter relative bottom-[2px] mt-2 transition-colors duration-300 animate-pulse-gold" style={{ animationDelay: "0s" }}>弘益人間</span>
                            </div>

                            <div className="group cursor-default transition-all duration-300 hover:scale-110 hover:-translate-y-1 flex flex-col items-center justify-center bg-transparent py-2">
                                <span className="text-2xl md:text-[2rem] font-black tracking-tighter relative top-[2px] transition-colors duration-300 animate-pulse-gold" style={{ animationDelay: "1.3s" }}>성통공완</span>
                                <span className="text-sm md:text-base text-[#d4af37]/70 group-hover:text-[#d4af37] font-serif tracking-tighter relative bottom-[2px] mt-2 transition-colors duration-300 animate-pulse-gold" style={{ animationDelay: "1.3s" }}>成通功完</span>
                            </div>
                            <div className="group cursor-default transition-all duration-300 hover:scale-110 hover:-translate-y-1 flex flex-col items-center justify-center bg-transparent py-2">
                                <span className="text-2xl md:text-[2rem] font-black tracking-tighter relative top-[2px] transition-colors duration-300 animate-pulse-gold" style={{ animationDelay: "2.6s" }}>재세이화</span>
                                <span className="text-sm md:text-base text-[#d4af37]/70 group-hover:text-[#d4af37] font-serif tracking-tighter relative bottom-[2px] mt-2 transition-colors duration-300 animate-pulse-gold" style={{ animationDelay: "2.6s" }}>在世理化</span>
                            </div>
                        </div>
                        <div className="flex flex-col space-y-4 text-gray-300 text-base md:text-lg leading-relaxed break-keep w-full max-w-3xl mx-auto px-4 text-center">
                            <p className="w-full">
                                세상을 널리 이롭게 하는 정신을 근본으로,<br />
                                세계 어느 나라도 따라할 수 없는 위대한 건국이념이며
                            </p>
                            <p className="w-full text-base md:text-lg">
                                종교와 이념으로 전쟁과 갈등의 지구촌에 필요한 이타적인 건국이념입니다.
                            </p>
                        </div>
                    </GlassCard>
                </div>

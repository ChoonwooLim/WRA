...
export default function CeoProfilePage() {
    ...
    // Fallback to static text if dictionary doesn't have it (since we only added the menu key to dict)
    const pageTitle = language === 'ko' ? '대표이사 프로필' : 'CEO Profile';
    const pageSubtitle = language === 'ko' ? '세계왕립아카데미 대표' : 'CEO, World Royal Academy';
                    ...
                    <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight">
                                제니킴 <span className="text-xl md:text-2xl text-gray-400 font-normal ml-2">(최유나)</span>
                            </h1>
                ...
                <div className="container mx-auto px-4 max-w-5xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <GlassCard className="p-8 border-t-4 border-t-[#8b5cf6]/50 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="text-xl font-bold text-white mb-4">심리·성향 기반 HR 진단 & 헤드헌팅</h3>
                        ...
                        <GlassCard className="p-8 border-t-4 border-t-[#00d4ff]/50 hover:-translate-y-2 transition-transform duration-300" delay={0.1}>
                            ...
                            <h3 className="text-xl font-bold text-white mb-4">기업 맞춤형 목표 달성 컨설팅</h3>
                            <p className="text-gray-400 text-sm leading-relaxed">
                        ...
                        <GlassCard className="p-8 border-t-4 border-t-[#d4af37]/50 hover:-translate-y-2 transition-transform duration-300" delay={0.2}>
                            ...
                            <h3 className="text-xl font-bold text-white mb-4">B2B 글로벌 특수 목적 프로젝트 총괄</h3>
                            <p className="text-gray-400 text-sm leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            <GlassCard className="p-5 flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400 text-sm">삼성전자, SK하이닉스, INFINIQ, LG전자 등</p>
                                </div>
                            </GlassCard>
                            <GlassCard className="p-5 flex items-start gap-4">
                                <div className="mt-1"><Building2 className="w-5 h-5 text-[#64ffda]" /></div>
                                <div>
                                    <h4 className="text-white font-bold mb-1">건설 & 엔지니어링</h4>
                                    <p className="text-gray-400 text-sm">현대엔지니어링, GS건설, 대우건설 등</p>
                                </div>
                            </GlassCard>
                            <GlassCard className="p-5 flex items-start gap-4">
                                <div className="mt-1"><Building2 className="w-5 h-5 text-[#64ffda]" /></div>
                                <div>
                                    <h4 className="text-white font-bold mb-1">유통 & 화학 & 자동차</h4>
                                    <p className="text-gray-400 text-sm">GS리테일, SKC, 현대자동차, 금호타이어, 도요타(TOYOTA) 등</p>
                                </div>
                            </GlassCard>
                            <GlassCard className="p-5 flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400 text-sm">클래스101(CLASS101) 마스터 클래스 진행, 성신여자대학교 출강</p>
                                </div>
                            </GlassCard>
                        </div>
                        ...
                        <GlassCard className="p-8 h-full bg-gradient-to-br from-[#120e26] to-[#0a081c]">
                            <h3 className="text-xl font-bold text-[#d4af37] mb-6 flex items-center gap-2">
                                <Award className="w-6 h-6" /> 주요 프로젝트 실적
                            </h3>
                            <ul className="space-y-6">
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-[#64ffda] mt-0.5 flex-shrink-0" />
                                    <div>
                                        <h4 className="text-white font-semibold mb-1">C-Level 임원진 맞춤형 비즈니스 코칭</h4>
                                        <p className="text-gray-400 text-sm">SKC 실장급 등 핵심 수석 임원진 대상 고위급 비즈니스 스피킹 및 전략 코칭 수행</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-[#64ffda] mt-0.5 flex-shrink-0" />
                                    <div>
                                        <h4 className="text-white font-semibold mb-1">신규 사업 및 해외 법인 진출 지원</h4>
                                        <p className="text-gray-400 text-sm">글로벌 확장을 위한 특화 인재 스크리닝 및 실무 협상 커뮤니케이션 컨설팅 성공적 완수</p>
                                    </div>
                                </li>
                            </ul>
                        </GlassCard>
                ...
                <div className="container mx-auto px-4 max-w-5xl relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                            ...
                            <GlassCard className="p-6 h-full transition-all duration-300 group-hover:scale-[1.02] group-hover:border-[#00d4ff]/30 group-hover:shadow-[0_0_30px_rgba(0,212,255,0.15)] flex flex-col justify-between">
                                <div>
                                    <div className="flex justify-between items-start mb-4">
                                        <span className="px-3 py-1 rounded-full bg-[#00d4ff]/10 text-[#00d4ff] text-xs font-bold font-serif">📰 한국일보 (2023.11)</span>
                        ...
                        <a href="https://www.kmib.co.kr/article/view.asp?arcid=0018262272" target="_blank" rel="noopener noreferrer" className="group">
                            <GlassCard className="p-6 h-full transition-all duration-300 group-hover:scale-[1.02] group-hover:border-[#d4af37]/30 group-hover:shadow-[0_0_30px_rgba(212,175,55,0.15)] flex flex-col justify-between">
                                <div>
                                    <div className="flex justify-between items-start mb-4">
                                        <span className="px-3 py-1 rounded-full bg-[#d4af37]/10 text-[#d4af37] text-xs font-bold font-serif">📰 국민일보 (2023.05)</span>
                    ...
                    <div className="flex flex-wrap gap-4 justify-center mt-8">
                        <span className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-gray-300 text-sm font-medium flex items-center gap-2">
                            <Award className="w-4 h-4 text-[#d4af37]" /> 연세대 창업경진대회 대상 (2회 우승)
                        </span>
                        <span className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-gray-300 text-sm font-medium flex items-center gap-2">
                            <Award className="w-4 h-4 text-[#d4af37]" /> 숨고, 마이멘토 누적 고용 600건 이상
                        </span>
                    </div>
                </div>
            </section>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="relative pl-8 md:pl-0">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-start md:items-center relative">
                                ...
                                <div className="w-full md:w-2/3 md:pl-8">
                                    <div className="md:hidden text-[#d4af37] font-bold text-sm font-mono mb-2">2021.01 ~ 현재</div>
                                    <GlassCard className="p-5 border-l-4 border-l-[#d4af37]">
                                        <h4 className="text-white font-bold text-lg">글로벌 비즈니스 전문 강사 / 컨설턴트</h4>
                                        <p className="text-gray-400 text-sm mt-1">기업 관련 맞춤 커뮤니케이션 전략 컨설팅</p>
                                    </GlassCard>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative pl-8 md:pl-0">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-start md:items-center relative">
                                ...
                                <div className="hidden md:block absolute left-[33.33%] md:translate-x-[7px] top-6 bottom-[-48px] w-px bg-white/10 z-0"></div>
                                <div className="w-full md:w-2/3 md:pl-8">
                                    <div className="md:hidden text-white font-bold text-sm font-mono mb-2">2020.01 ~ 현재</div>
                                    <GlassCard className="p-5">
                                        <h4 className="text-white font-bold text-lg">제니SA 대표 / 세계왕립아카데미 대표</h4>
                                        <p className="text-gray-400 text-sm mt-1">현재 WRA 글로벌 사업을 리드 및 경영전략 총괄</p>
                                    </GlassCard>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-start md:items-center relative">
                                ...
                                <div className="w-full md:w-2/3 md:pl-8">
                                    ...
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-5">
                                        <h4 className="text-white font-semibold">알파스터디, 스터디서치 전문 영어강사 (리더)</h4>
                                        <p className="text-gray-500 text-sm mt-1">프리랜서로서 다수 교육 플랫폼에서 활약</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative pl-8 md:pl-0">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-start md:items-center relative">
                                ...
                                <div className="w-full md:w-2/3 md:pl-8">
                                    ...
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-5">
                                        <h4 className="text-white/80 font-medium">무역회사 G&M 통번역사</h4>
                                        <p className="text-gray-500 text-sm mt-1">유럽 세관 담당팀 — 실무 비즈니스 협상 및 전문 커뮤니케이션</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-start md:items-center relative">
                                ...
                                <div className="w-full md:w-2/3 md:pl-8">
                                    ...
                                    <div className="bg-white/5 border border-white/5 rounded-xl p-5 opacity-70">
                                        <h4 className="text-white/60 font-medium">E&M 전문 영어학원</h4>
                                    </div>
                                </div>
                            </div>
                        </div>

...
const museumTours = [
    {
        ...
        desc: '조선왕실과 대한제국 황실의 역사를 집대성한 보물창고. 어보, 순종황제 어차 등 왕실의 눈물이 배어 있는 역사적 유물 전시.',
        highlight: '조선·대한제국 황실 보물창고',
    ...
    },
    {
        ...
        desc: '덕수궁 석조전 내에 위치한 특별 전시. 근대 황실의 외교, 군사, 문화 활동을 소개합니다.',
        highlight: '덕수궁 석조전 · 근대 황실 전시',
        duration: '1.5시간', capacity: '20명',
...
export default function ToursPage() {
    ...
    const palaceData: Record<string, any> = {
        ...
        '국립고궁박물관': {
            ...
            intro: [
                "국립고궁박물관은 조선 왕실과 대한제국 황실의 역사와 문화를 집대성한 보물창고입니다.",
                "하지만 이 박물관의 역사 자체가 우리 근현대사의 아픔을 그대로 닮아 있습니다.",
                "1908년 '제실박물관'으로 시작된 이곳은 일제 강점기 동안 '이왕가미술관'으로 격하되어 덕수궁 석조전으로 쫓겨나는 수모를 겪었습니다. 해방 후에도 여러 이름을 전전하다가 2005년에야 비로소 경복궁의 품으로 돌아왔습니다. 이곳에 전시된 유물 하나하나에는 망국의 슬픔을 견디며 정통성을 지키려 했던 황실의 눈물이 배어 있습니다."
            ],
            sections: [
                {
        ...
        '서울역사박물관': {
            ...
            sections: [
                {
                    title: "1. 황실의 유산: 운현궁과 이우 왕자의 기증",
                    paragraphs: [
                        "비록 건립 과정은 아팠지만, 이곳의 콘텐츠는 황실의 헌신으로 채워졌습니다. 1991년, 흥선대원군의 사가였던 운현궁의 유물들이 이우 왕자의 장자인 이청 황손에 의해 기증되었습니다.",
                        "이는 황실의 유물이 개인의 소유물이 아니라, '국민 모두가 공유해야 할 공공의 자산'이라는 황실 가족들의 뜻이 담긴 것입니다."
                    ]
                },
                {
                    ...
                    paragraphs: [
                        ...
                        "상아로 만든 이 부채는 명성황후께서 알렌 부인에게 하사한 것으로, 국내외를 통틀어 유일한 조선 왕실의 상아 부채입니다. 이 작은 부채에는 서구 열강과 교류하며 자주 독립을 꿈꾸었던 황실의 '글로벌 마인드'와 비극적으로 생을 마감하신 황후의 체취가 서려 있습니다."
                    ]
                },
                {
        ...
        '대한제국역사관': {
            ...
            intro: [
                "덕수궁 석조전 내에 위치한 대한제국역사관은, 자주적 근대 국가를 꿈꾸었던 황실의 비전이 담긴 곳입니다.",

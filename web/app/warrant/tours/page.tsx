...
export default function ToursPage() {
    ...
    const [unescoOpen, setUnescoOpen] = useState(true);

    return (
        <div className="bg-[#050510] min-h-screen">
            {/* UNESCO Heritage Section (moved from Korean Studies) */}
            <section className="pt-32 pb-16 relative overflow-hidden bg-[#050510]">
                ...
                <div className="container mx-auto px-4 max-w-6xl relative z-10">
                    ...
                    >
                        ...
                        <button
                            onClick={() => setUnescoOpen(prev => !prev)}
                        ...
                        >
                            ...
                            <span className={`text-[#d4af37] text-xl transition-transform duration-300 ${unescoOpen ? 'rotate-180' : ''}`}>▾</span>
                        </button>
                    </motion.div>

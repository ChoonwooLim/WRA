...
import { BookOpen, GraduationCap, Compass, Sparkles, Brain, Lightbulb, Layers, Target, Clock, Users, Heart, MessageSquare } from 'lucide-react';
                                ...
                                >
                                    <GlassCard delay={idx * 0.05}>
                                        ...
                                        <ul className="space-y-2">
                                            {fmt.details.map((d: string, i: number) => (
